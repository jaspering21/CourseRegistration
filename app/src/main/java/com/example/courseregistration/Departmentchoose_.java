...
public class Departmentchoose_ extends AppCompatActivity {
    //public static final String EXTRA_MESSAGE = "com.example.courseregistration.MESSAGE";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(Departmentchoose_.this, Main3Activity.class);
